...
| [ROADMAP-CIBLE1.md](ROADMAP-CIBLE1.md) | Cible 1 — « CI / Text Quality Gate » (validée : A v2.2.0, B+C v2.6.0) |
...
4. `ROADMAP-CIBLE1.md` — la cible validée (incrément A v2.2.0, B et C v2.6.0) et ses critères
   d'acceptation.
